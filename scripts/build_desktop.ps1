...
if (-not $SkipSelfTest) {
    ...
    foreach ($requiredCheck in @(
        ...
        'SYNTHETIC_SERVICE_COST_QUERY', 'SYNTHETIC_DRIVER_CONFIRMED_TIRES',
        'SYNTHETIC_TIRE_CAPTURE_REPLAY',
        'SYNTHETIC_TIRE_REVIEW_EXPORT',
        'SYNTHETIC_TIRE_VOICE_CONFIRMATION',
        'SYNTHETIC_TIRE_CALIBRATION_BINDING',
        'SYNTHETIC_CONDITIONAL_TIRE_COMPARISON',
        'SYNTHETIC_MAPPED_REJOIN_QUERY',
        'SYNTHETIC_PIT_OBSERVATION_DRAFT',
        'SYNTHETIC_CAPTURE_RECOMPUTATION',
